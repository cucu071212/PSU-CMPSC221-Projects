...
public class FunctionalProgrammingTemplate {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%n%nInvoices sorted by Part description%n");
        System.out.println("Part number\tPart description\tQuantity\tPrice per item\tValue");
        invoices.stream()
        ...
        System.out.printf("%n%nInvoices sorted by Price%n");
        System.out.println("Part number\tPart description\tQuantity\tPrice per item\tValue");
        invoices.stream()
        ...
        System.out.printf("%n%nPart Description and Quantity for each Invoice%n");
        System.out.println("Part description\tQuantity");
        invoices.stream()
                .sorted(Comparator.comparing(Invoice::getQuantity))
                .map(Invoice -> String.format("%-20s%12d", Invoice.getPartDescription(), Invoice.getQuantity()))
